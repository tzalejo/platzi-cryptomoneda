'use strict';
const MongoClient = require('mongodb').MongoClient; // inclusion de mongodb
const { DB_HOST, DB_PORT, DB_NAME } = require("./config");// tomamos valores de configuracion(.json)..
const connectionUrl = `mongodb://${DB_HOST}:${DB_PORT}`; 


module.exports = (()=>{  // estamos exportando 
